...
class Firebase {
  static dynamic read_cloudfs(String docpath, dynamic id) {
  ...
  static dynamic write_cloudfs(String docpath, dynamic id, Map<String, dynamic> obj) {
    final DocumentReference ref = Firestore.instance.document(
        docpath + id.toString());
    Firestore.instance.runTransaction((Transaction tx) async {
      DocumentSnapshot snap = await tx.get(ref);
  ...
  static int get_new_id(String docpath) {
  ...
  static void inc_roster_state(int roster_id) {
    final DocumentReference ref = Firestore.instance.document(
